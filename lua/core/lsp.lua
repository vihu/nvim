...
local function restart_lsp(bufnr)
  ...
  if lsp.get_clients then
    clients = lsp.get_clients { bufnr = bufnr }
  else
    ---@diagnostic disable-next-line: deprecated
    clients = lsp.get_active_clients { bufnr = bufnr }
  end
...
api.nvim_create_user_command('LspStatus', lsp_status, { desc = 'Show detailed LSP status' })
...
api.nvim_create_user_command('LspCapabilities', check_lsp_capabilities, { desc = 'Show LSP capabilities' })
...
local function lsp_diagnostics_info()
  ...
  for _, diagnostic in ipairs(diagnostics) do
    local severity = diag.severity[diagnostic.severity]
...
api.nvim_create_user_command('LspDiagnostics', lsp_diagnostics_info, { desc = 'Show LSP diagnostics count' })
...
local function lsp_info()
  ...
  -- Basic info
  print('󰈙 Language client log: ' .. lsp.get_log_path())
